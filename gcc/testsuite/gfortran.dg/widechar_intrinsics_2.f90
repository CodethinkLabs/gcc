...
program failme
  ...
  call ctime (i8, s1) ! { dg-warning "GNU Extension" }
  call ctime (i8, s4) ! { dg-error "must be of kind" }

  call chdir (s1)     !{ dg-warning "GNU Extension" }
  call chdir (s1, i)
  call chdir (s4) ! { dg-error "must be of kind" }
  call chdir (s4, i) ! { dg-error "must be of kind" }

  call chmod (s1, t1) ! { dg-warning "GNU Extension" }
  ...
  call fdate (s1) ! { dg-warning "GNU Extension" }
  call fdate (s4) ! { dg-error "must be of kind" }

  call gerror (s1) ! { dg-warning "GNU Extension" }
  call gerror (s4) ! { dg-error "must be of kind" }

  call getcwd (s1) ! { dg-warning "GNU Extension" }
  call getcwd (s1, i)
  call getcwd (s4) ! { dg-error "must be of kind" }
  call getcwd (s4, i) ! { dg-error "must be of kind" }

  call getenv (s1, t1) ! { dg-warning "GNU Extension" }
  ...
  call perror (s1) ! { dg-warning "GNU Extension" }
  call perror (s4) ! { dg-error "must be of kind" }

  call rename (s1, t1) ! { dg-warning "GNU Extension" }
